...
#   
cls
$mod_dir = "B:\Users\Richard\Desktop\patch_script_starbound\starbound"
#In case you want to specify it from the shell, use below command
#$mod_dir = Read-Host "Specify the mod directory"
$scan_obj_dir="B:\Users\Richard\Desktop\patch_script_starbound\starbound\betterblocks"
       ...
       #Write the content into the file
        Write-Output "[" | Out-File $patch_file_name 
         Write-Output "{" | Out-File $patch_file_name -Append
            ...
            Write-Output '"value"="/station"' | Out-File $patch_file_name -Append
         Write-Output "}" | Out-File $patch_file_name -Append
         Write-Output "]" | Out-File $patch_file_name  -Append    
   } 
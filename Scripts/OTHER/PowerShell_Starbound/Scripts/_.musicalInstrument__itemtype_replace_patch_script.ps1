       ...
       #Write the content into the file
        Write-Output "[" | Out-File $patch_file_name -encoding utf8
         ...
         Write-Output "  {" | Out-File $patch_file_name -Append -encoding utf8
                ...
                if($matched_content.Length -ge 1){  Write-Output '    "op": $a,' | Out-File $patch_file_name -Append -encoding utf8 } 
                else {  Write-Output '    "op": "$a",' | Out-File $patch_file_name -Append -encoding utf8  }
            Write-Output '    "path": "/itemType",' | Out-File $patch_file_name -Append -encoding utf8
